...
import { ADD_CHARACTER, UPDATE_CHARACTER } from 'utils/mutations/characterMutations'
...
const CharacterBuilder = () => {
  ...
  const [addCharacter, { error: character_error }] = useMutation(ADD_CHARACTER, {
    refetchQueries: [{ query: QUERY_USER_CHARACTERS }]
  })
  ...
  return (
    <div>
      <PageHeader image={`url(${require('assets/images/card_backs/back_9.jpg')})`} pageTitle={'Character Builder'} />
      <Form onSubmit={e => e.preventDefault()} className="container d-flex flex-column">
        ...
        <div className="d-flex justify-content-around text-center">
          ...
          <FormGroup controlId="armor_class" className="d-flex flex-column align-items-center">
        ...
        <FormGroup controlId="race" className="mt-2">
          ...
          <FormSelect name="race" value={values.race} onChange={handleChange} className="form-select" required>
        ...
        <FormGroup controlId="class" className="mt-2">
          ...
          <FormSelect name="class" value={values.class} onChange={handleChange} className="form-select" required>
            <option value="" disabled>
              Select...
            </option>
            {getPlayerClasses()}
