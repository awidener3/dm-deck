	...
	return (
		<div>
			<div className="p-4 d-flex flex-column align-items-center container">
				...
				<p>
					All of the rest of dm-deck.com is Open Game Content as
				...
				<p>
					...
					Inc. and is Copyright 2000{' '}
					<em>Wizards of the Coast, Inc</em> ("Wizards"). All Rights
					Reserved.
				</p>
				...
				<p>
					...
					Content; (f) "Trademark" means the logos, names, mark, sign,
					motto, designs that are used by a Contributor to identify
					itself or its products or the associated products
					contributed to the Open Game License by the Contributor (g)
					"Use", "Used" or "Using" means to use, Distribute, copy,
