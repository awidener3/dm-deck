...
import { DELETE_COLLECTION, REMOVE_BATTLE_FROM_COLLECTION } from 'utils/mutations/battleMutations'
...
const Collection = () => {
  ...
  const [removeBattleFromCollection] = useMutation(REMOVE_BATTLE_FROM_COLLECTION)
      ...
      <PageHeader
        image={
          collection.background_img
            ? `url(${require('assets/images/card_backs/' + collection.background_img)})`
